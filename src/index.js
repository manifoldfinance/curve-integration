...
initWeb3() {
  ...
  /*
   * @dev Check every second for switching network or switching wallet
   */
  ...
  deployContract() {
    ...
    this.MoneyToCurve = new global.web3.eth.Contract(
      MoneyToCurveArtifacts.abi,
      this.address,
    );
  }
